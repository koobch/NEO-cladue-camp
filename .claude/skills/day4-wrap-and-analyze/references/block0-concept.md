...
- 문서담당 팀장: "CLAUDE.md 경영 현황 반영하고, 전략 문서 갱신했습니다"
- 자동화담당 팀장: "반복 보고 자동화 포인트를 찾았습니다 — KPI 수집, 주간 브리핑, 회의록 템플릿화"
- 학습담당 팀장: "이번 주 의사결정 패턴을 정리하고, 결정사항을 목록화했습니다"
- 후속작업담당 팀장: "미완료 액션 아이템을 추적하고, 다음 경영회의 준비물을 정리했습니다"
...
| 전문가 | 하는 일 |
|--------|---------|
| doc-updater | CLAUDE.md 경영 현황 반영, 전략 문서 갱신 |
| automation-scout | 반복 보고 자동화 (KPI 수집, 주간 브리핑), 회의록 템플릿화 |
| learning-extractor | 의사결정 패턴 학습, 이번 주 결정사항 정리 |
| followup-suggester | 미완료 액션 아이템 추적, 다음 경영회의 준비물 안내 |
...
정리하면, session-wrap은 **"경영지원본부에서 퇴근 전에 일일이 정리할 필요 없이, Claude가 알아서 재무/인사/총무 등 각 담당에게 보고를 받고 정리해주는 것"**입니다.
...
- "이걸 경영지원본부(재무/인사/총무) 업무에 적용하면 어떤 모습이 될까?"
...
**정답: 3번.** Phase 1에서 4명의 전문가가 독립적으로 분석하면, 비슷한 제안이 나올 수 있다. Phase 2의 duplicate-checker가 이런 중복을 걸러내서 깔끔한 결과만 사용자에게 보여준다.
